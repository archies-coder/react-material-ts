          ...
          <Grid container>
            ...
            <Grid item xs={6}>
              <Box
                ...
                style={{ position: "relative", top: "32px", right: "86px" }}
              >
                <SelectInput
                  value="Actions"
                  width={147}
                ...
                <Box className={classes.button}>
                  <CustomButton
                    style={{ height: "38px", width: "168px", marginTop: "1px" }}
